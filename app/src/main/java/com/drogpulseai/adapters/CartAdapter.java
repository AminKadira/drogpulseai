...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public CartAdapter(Context context, List<Map<String, Object>> carts, OnCartClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvCartInfo.setText(String.format(Locale.getDefault(),
                "Panier #%d - %s", cartId, formattedDate));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvCartInfo, tvContactName, tvStatus, tvDetails;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvCartInfo = itemView.findViewById(R.id.tv_cart_info);
